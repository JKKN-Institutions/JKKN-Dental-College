...
export default function ElectricWave({
  ...
  const getAlternateWavePath = () => {
    const isHorizontal = position === "top" || position === "bottom";
    if (isHorizontal) {
      return "M0,40L48,45.3C96,51,192,61,288,64C384,67,480,64,576,56C672,48,768,37,864,42.7C960,48,1056,72,1152,77.3C1248,83,1344,72,1392,66.7L1440,61L1440,0L1392,0C1344,0,1248,0,1152,0C1056,0,960,0,864,0C768,0,672,0,576,0C480,0,384,0,288,0C192,0,96,0,48,0L0,0Z";
    } else {
      return "M40,0L45.3,48C51,96,61,192,64,288C67,384,64,480,56,576C48,672,37,768,42.7,864C48,960,72,1056,77.3,1152C83,1248,72,1344,66.7,1392L61,1440L0,1440L0,1392C0,1344,0,1248,0,1152C0,1056,0,960,0,864C0,768,0,672,0,576C0,480,0,384,0,288C0,192,0,96,0,48L0,0Z";
    }
  };

  const getSecondaryWavePath = () => {
    const isHorizontal = position === "top" || position === "bottom";
    if (isHorizontal) {
      return "M0,24L48,29.3C96,35,192,45,288,48C384,51,480,48,576,40C672,32,768,21,864,26.7C960,32,1056,56,1152,61.3C1248,67,1344,56,1392,50.7L1440,45L1440,0L1392,0C1344,0,1248,0,1152,0C1056,0,960,0,864,0C768,0,672,0,576,0C480,0,384,0,288,0C192,0,96,0,48,0L0,0Z";
    } else {
      return "M24,0L29.3,48C35,96,45,192,48,288C51,384,48,480,40,576C32,672,21,768,26.7,864C32,960,56,1056,61.3,1152C67,1248,56,1344,50.7,1392L45,1440L0,1440L0,1392C0,1344,0,1248,0,1152C0,1056,0,960,0,864C0,768,0,672,0,576C0,480,0,384,0,288C0,192,0,96,0,48L0,0Z";
    }
  };
