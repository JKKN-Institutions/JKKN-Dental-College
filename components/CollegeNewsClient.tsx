...
import type { CollegeNews } from '@/app/admin/content/sections/[id]/edit/_actions/college-news-actions';

interface CollegeNewsClientProps {
  newsItems: CollegeNews[];
}

export default function CollegeNewsClient({ newsItems }: CollegeNewsClientProps) {
