...
export const permissionPresets = {
  ...
  contentManager: {
    ...
    home_sections: { view: true, create: true, update: true, delete: true },
...
> = {
  ...
  pages: {
    label: 'Pages',
    description: 'Manage dynamic website pages',
    actions: [
      { action: 'view', label: 'View Pages', description: 'Can view pages and page list' },
      { action: 'create', label: 'Create Pages', description: 'Can create new pages' },
      { action: 'update', label: 'Update Pages', description: 'Can edit page content and settings' },
      { action: 'delete', label: 'Delete Pages', description: 'Can delete pages' },
    ],
  },
  home_sections: {
    label: 'Home Sections',
    description: 'Manage homepage section ordering and visibility',
    actions: [
      { action: 'view', label: 'View Sections', description: 'Can view home sections' },
      { action: 'create', label: 'Create Sections', description: 'Can create new sections' },
      { action: 'update', label: 'Update Sections', description: 'Can edit section settings and ordering' },
      { action: 'delete', label: 'Delete Sections', description: 'Can delete sections' },
    ],
  },
  announcements: {
    label: 'Announcements',
